...
def demo(data, save, model='densenet', pretrained=True, depth=40, growth_rate=12, batch_size=256):
    ...
    output_file = os.path.join(save, model, 'model_with_Platt.out')
    ...
    orig_model = ModelWithPlatt(orig_model)

    # Tune the model temperature, and save the results
    orig_model.set_a_b(valid_loader)
    model_filename = os.path.join(save, model, "model_with_Platt.pth")
